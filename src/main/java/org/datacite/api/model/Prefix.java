...
import org.datacite.api.model.PrefixData;
...
public class Prefix {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Prefix.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        PrefixData.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
  }
