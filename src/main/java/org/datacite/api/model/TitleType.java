 ...
 */
@JsonAdapter(TitleType.Adapter.class)
public enum TitleType {
  ...
  public static class Adapter extends TypeAdapter<TitleType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TitleType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TitleType read(final JsonReader jsonReader) throws IOException {
